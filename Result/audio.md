...
- [00:10.90 - 00:29.26] **Кулошвили**: Нет, заявка то создаётся или день в день, или заранее как-то, вот, я не знаю, даже попробовать как-то. Ну я не за это не отвечаю, я, то есть это, это моменты, я полторы минуты.
...
- [00:15.54 - 00:19.86] **Судья**: Угу. Ну то есть её вывести, то есть датой той датой, ну, можно будет её там.
